    ...
    <div class="col-lg-4">
        <div class="card mb-4">
            <div class="card-body text-center">
                <img src="<?php echo($userDetailsExist ? $userDetails['pro_pic'] : '/tech-blog/img/avatar.png') ?>" alt="pro_pic" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
